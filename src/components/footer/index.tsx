        ...
        <div className="flex justify-between max-md:flex-wrap max-md:space-x-0 items-start w-full border-b  border-b-[#333333]">
          ...
          <div className="flex pb-10  max-md:mt-10 flex-col space-y-5 justify-center max-md:items-center items-start max-md:w-full w-[25%]">
            ...
            <div className="flex px-2 flex-col space-y-5 justify-center items-start max-md:items-center">
              <div className="flex justify-start items-start max-md:items-center  max-md:justify-center space-x-5 text-lg cursor-pointer hover:text-[#0044BB] text-[#777777]">
                <Image src={locationImg} className="mt-3" alt="phone" />
                <p className="text-[#555555] w-[60%] text-wrap">{location}</p>
              </div>
              <div className="flex justify-start items-start max-md:items-center max-md:justify-center text-lg space-x-5  cursor-pointer hover:text-[#0044BB] text-[#777777]">
              ...
              <div className="max-md:w-full flex justify-start items-start max-md:items-center max-md:justify-center text-lg  space-x-5 cursor-pointer hover:text-[#0044BB] text-[#777777]">
