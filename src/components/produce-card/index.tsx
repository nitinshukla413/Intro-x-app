...
import Mails from "../../../public/assets/images/message.png";
    ...
    <div
      ...
      className={`${
        mobileView
          ...
          : ""
      } cursor-pointer  shadow-[5px_5px_15px_-5px_rgba(0,0,0,0.3)] max-md:flex-col hover:scale-105 flex delay-3000  mZax-md:w-full border-[#c3c3c4] rounded-xl  bg-[#FFFEFE] `}
    >
      <Image
        alt="image"
        src={image || TempImg}
        className={`flex-[0.75]  rounded-l-xl max-md:w-full ${mobileView?'rounded-l-xl max-md:w-full':""}`}
      ></Image>
      <div className="flex flex-col justify-start items-start p-5 flex-[0.5] space-y-5 max-md:w-full">
        ...
        <div className="flex flex-col w-full space-y-1">
          <div className="flex space-x-2">
            <Image src={Customer} className="h-3 w-3" alt="customer" />
            <h4 className="text-xs text-[#949393]">
              {Bname || "Joshi real estate"}
            </h4>
          </div>
          <div className="flex space-x-2 pb-3 border-b border-[#d1d1d1]">
            <Image src={Location} className="h-3 w-3" alt="customer" />
            <h4 className="text-xs text-[#949393]">{Blocation || "Pune"}</h4>
          </div>
          <div className="flex  w-full cursor-pointer pt-2">
            <div className="flex w-full  space-x-1 justify-center items-center border-r  border-[#c3c3c4]">
              <Image src={Call} className="h-6 w-6" alt="customer" />
            ...
            <div className="flex border-r-1  space-x-1  justify-center  w-full items-center border-[#515151]">
              <Image src={Mails} className="h-6 w-6" alt="customer" />
